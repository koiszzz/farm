...
const OUTPUT_PATH := "res://design/qa/2026-09-24/avatar-walk-v4/live-cycle.png"
const RUN_OUTPUT_PATH := "res://design/qa/2026-09-24/avatar-walk-v4/live-run-cycle.png"
...
func _capture() -> void:
	...
	for row in directions.size():
		...
		for column in 8:
			...
			actors.append(actor)
	DirAccess.make_dir_recursive_absolute("res://design/qa/2026-09-24/avatar-walk-v4")
